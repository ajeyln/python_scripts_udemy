class Song:
    ...
    Attributes:
        ...
        duration (int): The duration of the song ion seconds. May be zero
    """
    def __init__(self, title, artist, duration=0):
        """Song init method
        Args:
        title(str): Initialises the 'title' attribute
        artist (Artist): An Artist object reprsenting the song's creator.
        duration (Optional[int]): Initial value for the 'duration' attribute. 
            will default to zero if not specified.The duration of the song ion seconds.
        """
        self.title = title
        self.artist = artist
...
class Artist:
    ...
    def add_album(self, album):
        """ Add a new album to this list.
        Args:
        album(Album): Album object to add to the list.
            If the album is already present, it will not added again (although this is yet implemented).
        """
...
def create_file(artist_list):
    """ Create a check file from the object data for comparison with the original file"""
    with open("Checkfile", 'w') as checkfile:
        for new_artist in artist_lists:
