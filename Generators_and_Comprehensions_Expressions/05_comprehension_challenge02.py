...
#
#out dimension will be represented by a tuple, for the length, width and height.
#
#There are 2.54 centimeter to 1 inch
...
# once you've got the correct values, change the code to produce a tuple, rather than list.
