...
# The list should contain the description of the each location, if it's possible to get to the forest from there.
#
# The forest is location 5 in the location directory
# The exists for each location are represented by the exits dictionary.
#
# Remember that a dictionary a .values() method, to return a list of the values.
#
# The forest can be reached from the road, and the hill; so those should be description that appear in you list
#
...
# In other words, use a for loop to run the comprehension for each of the keys in the location directory.
